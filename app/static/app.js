...
const I18N = {
  es: {
    ...
    compareGeneratedLabel: "Nuevo STT",
    compareGeneratedProvider: "Generado por {provider}.",
    compareOriginalLabel: "Original sincronizado",
    compareOriginalHint: "Texto del SRT/VTT subido; se retima con timestamps por palabra si estan disponibles.",
    compareMatchLabel: "Badge match",
    compareMatchHint: "MATCH OK encaja; +/- ms marca desfase; solo STT/original indica que no hay pareja.",
    timeMatchColumn: "Tiempo + match",
    timeMatchColumnHint: "Estado del emparejado",
    newSttColumn: "STT nuevo",
    newSttColumnHint: "WhisperX local / ElevenLabs",
    syncedOriginalColumn: "Original sync",
  ...
  en: {
    ...
    compareGeneratedLabel: "New STT",
    compareGeneratedProvider: "Generated by {provider}.",
    compareOriginalLabel: "Synced original",
    compareOriginalHint: "Uploaded SRT/VTT text; retimed with word timestamps when available.",
    compareMatchLabel: "Match badge",
    compareMatchHint: "MATCH OK lines up; +/- ms shows drift; STT/original only means no pair.",
    timeMatchColumn: "Time + match",
    timeMatchColumnHint: "Pairing status",
    newSttColumn: "New STT",
    newSttColumnHint: "Local WhisperX / ElevenLabs",
    syncedOriginalColumn: "Synced original",
...
function renderCompareExplainer() {
  ...
  providerExplain.textContent = t("compareGeneratedProvider", {
